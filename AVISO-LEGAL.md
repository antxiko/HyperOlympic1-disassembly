...
**El juego no es nuestro.** *Hyper Olympic 1* lo publico **Konami** para MSX en 1984; su
numero de catalogo es **RC-710** y son 16 KB. Todos los derechos sobre el juego
...
El fichero `src/hyperolympic1.asm` es el desensamblado comentado del cartucho. Se publica
...
Donde se cotejan cosas de fuera del cartucho -las marcas de atletismo de la
tabla de records, por ejemplo- se dice que son un cotejo externo y no algo que
diga el binario.

## Si eres uno de los autores

Si trabajaste en *Hyper Olympic 1* o tienes derechos sobre el juego, y preferirias que este
