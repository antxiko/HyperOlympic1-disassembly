...
**The game is not ours.** *Hyper Olympic 1* was published by **Konami** for the MSX in 1984;
its catalogue number is **RC-710** and it is 16 KB. All rights over the game
...
The file `src/hyperolympic1.asm` is the commented disassembly of the cartridge. It is
...
Where something outside the cartridge is cross-checked -the athletics marks in
the world-record table, for instance- it is stated as an external cross-check
and not as something the binary says.

## If you are one of the authors

If you worked on *Hyper Olympic 1* or hold rights over the game, and you would rather this
