...
#
# 0x4218 arranca la partida poniendo 0xE015 y 0xE016 a 1. Aqui se para justo
# despues (0x4220) y se cambia 0xE016 por la prueba que se quiere ver; de ahi
...
#
# Uso: PRUEBA=2 openmsx -machine Philips_VG_8020 -cart hyperolympic1.rom \
