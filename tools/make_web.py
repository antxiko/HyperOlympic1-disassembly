...
HALLAZGOS = {
    "es": [
        ...
        ("No pertenece a ninguna de las dos familias Konami ya medidas",
         ...
         "serie no llega al 2 %, y sus tramos comunes más largos van de 21 a 42 "
         "bytes, frente a los <b>681 seguidos</b> que comparte con el "
         "hermano.</p>"
    ...
    "en": [
        ...
        ("It belongs to neither of the two Konami families already measured",
         ...
         "and their longest common runs go from 21 to 42 bytes, against the "
         "<b>681 consecutive</b> ones it shares with the sibling.</p>"
