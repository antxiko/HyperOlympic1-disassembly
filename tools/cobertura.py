...
largo(0x5C96)                                   # 0x4127  pantalla del titulo
largo(0x6362)                                   # 0x4238  marco del marcador
for i in range(1, 5):                           # tabla A, 0x4265
    largo(W(0x4F33 + 2 * i))
for i in range(1, 5):                           # tabla B, 0x4253
    lista(W(0x4F3B + 2 * i))
for i in range(1, 5):                           # tabla C, 0x4934
    corto(W(0x4F43 + 2 * i))
p = 0x4E87                                      # 0x4AF1, cinco grupos
for _ in range(5):
    p = corto(p)
for a in (0x5024, 0x50F4, 0x5111, 0x5140):      # guiones cortos sueltos
    corto(a)
