...
NAV_EN = [("index.html", "Home"), ("GETTING-STARTED.html", "Start"),
          ...
          ("COMPARISON-TRACK-AND-FIELD.html", "vs Track &amp; Field")]
NAV_ES = [("index.html", "Portada"), ("EMPEZAR.html", "Empezar"),
          ...
          ("COMPARATIVA-TRACK-AND-FIELD.html", "vs Track &amp; Field")]
...
_PAREJAS = [("GETTING-STARTED.html", "EMPEZAR.html"),
            ...
            ("COMPARISON-TRACK-AND-FIELD.html",
             "COMPARATIVA-TRACK-AND-FIELD.html")]
PAREJA = {}
...
PIE = {
    "es": "<em>Hyper Olympic 1</em> lo publico Konami para MSX; su numero de catalogo es RC-710 y son 16 KB. Todos los derechos sobre el juego siguen siendo de sus titulares. Este trabajo es de preservacion, estudio y documentacion, y la imagen del cartucho no se distribuye.",
    "en": "<em>Hyper Olympic 1</em> was published by Konami for the MSX; its catalogue number is RC-710 and it is 16 KB. All rights in the game remain with their holders. This is preservation, study and documentation work, and the cartridge image is not distributed.",
}
...
REPO = os.environ.get("HYPEROLYMPIC_REPO",
                      "https://github.com/antxiko/HyperOlympic1-disassembly")
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — Hyper Olympic 1 (Konami, 1984)"
